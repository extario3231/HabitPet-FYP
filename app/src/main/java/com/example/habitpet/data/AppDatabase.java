...
import com.example.habitpet.data.dao.BuiltinHabitDao;
...
@Database(entities = {Habit.class, PetProgress.class, Task.class, BuiltinHabit.class, CalendarProgress.class}, version = 1)
